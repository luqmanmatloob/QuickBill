...
//           dateOrdered: rowData['Date Ordered'] || '',
//           dateDue: rowData['Date Due'] || '',
//           orderTotal: parseFloat(rowData['Order Total']) || 0,
//           billingCity: rowData['Billing City'] || '',
//           billingAddress: rowData['Billing Address'] || '',
//           billingState: rowData['Billing State'] || '',
//           shippingAddress: rowData['Shipping Address'] || '',
//           shippingCity: rowData['Shipping City'] || '',
//           shippingMethod: rowData['Shipping Method'] || '',
//           shippingState: rowData['Shipping State'] || '',
//           shippingPostcode: rowData['Shipping Postcode'] || '',
//           items: [{
//             productName: rowData['Product Name'] || '',
//             productCode: rowData['Product Code'] || '',
//             size: rowData['Size'] || '',
//             color: rowData['Color'] || '',
//             lineQty: parseInt(rowData['Line Qty']) || 1,
//             decorationProcess: rowData['Decoration Process'] || '',
//             unitPrice: parseFloat(rowData['Unit Price']) || 0,
//             lineTotal: parseFloat(rowData['Line Total']) || 0,
//             tax: parseFloat(rowData['Tax']) || 0,
//             taxExempt: rowData['Tax Exempt'] === 'true',
//             orderShippingTotal: parseFloat(rowData['Order Shipping Total']) || 0,
//             poNumber: rowData['PO Number'] || '',
//             supplierPoNumber: rowData['Supplier PO Number'] || '',
//             productionStaffAccount: rowData['Production Staff Account'] || '',
//             storeName: rowData['Store Name'] || '',
//             company: rowData['Company'] || '',
//             billingFirstName: rowData['Billing First Name'] || '',
//             billingLastName: rowData['Billing Last Name'] || '',
//             billingEmailAddress: rowData['Billing Email Address'] || '',
//             billingCity: rowData['Billing City'] || '',
//             billingState: rowData['Billing State'] || '',
//             billingPostcode: rowData['Billing Postcode'] || '',
//             billingPhoneNo: rowData['Billing Phone No'] || '',
//             shippingFirstName: rowData['Shipping First Name'] || '',
//             shippingLastName: rowData['Shipping Last Name'] || '',
//             shippingAddress: rowData['Shipping Address'] || '',
//             shippingCity: rowData['Shipping City'] || '',
//             shippingState: rowData['Shipping State'] || '',
//             shippingPostcode: rowData['Shipping Postcode'] || '',
//             shippingPhoneNo: rowData['Shipping Phone No'] || '',
//             shippingMethod: rowData['Shipping Method'] || '',
//             designName: rowData['Design Name'] || '',
//             designPrice: parseFloat(rowData['Design Price']) || 0
//           }],
//           note: '' 
//         };
